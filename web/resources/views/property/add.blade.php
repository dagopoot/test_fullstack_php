                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('property.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="property_type" class="form-select @error('property_type') is-invalid @enderror" name="property_type" required>
                                    ...
                                    <option value="{{ $property_type }}" @if (old('property_type')==$property_type) selected @endif>{{ $property_type }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input class="form-check-input" type="radio" name="operation" @if (old('operation')=='SALE' ) checked @endif @if (old('operation')=='' ) checked @endif id="operationSale" value="SALE">
                                <label class="form-check-label" for="operationSale">
                                    Venta
                                </label>

                                <input class="form-check-input" type="radio" name="operation" @if (old('operation')=='RENT' ) checked @endif id="operationRent" value="RENT">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="property_number" type="text" class="form-control @error('property_number') is-invalid @enderror" name="property_number" value="{{ old('property_number') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" required rows="3">{{ old('description') }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <label>
                                    <input type="checkbox" class="form-check-input" name="amenities[]" value="{{ $amenity->id }}">
                                    {{ $amenity->name }}
                                </label>
                                @endforeach
                            </div>
